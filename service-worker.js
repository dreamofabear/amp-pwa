...
var precacheConfig = [["index.html","3609b8e528e46af78244bb83a3f7750e"],["manifest.webmanifest","5ac055207c3ba306d8a465404b66ddf0"],["static/css/main.0f2fcf3f.css","0b51b69313443865aac958e988cae268"],["static/js/main.06bb6a7f.js","70af57bcbb617ef10c64afdfcaaf513a"],["static/media/favicon.8166c81d.png","8166c81d3999ac6aec439499291d31a1"],["static/media/font.143adccf.woff","143adccf07a5ae3cad8b6d004f815f50"],["static/media/glyphicons-halflings-regular.448c34a5.woff2","448c34a56d699c29117adc64c43affeb"],["static/media/glyphicons-halflings-regular.89889688.svg","89889688147bd7575d6327160d64e760"],["static/media/glyphicons-halflings-regular.e18bbf61.ttf","e18bbf611f2a2e43afc071aa2f4e1512"],["static/media/glyphicons-halflings-regular.f4769f9b.eot","f4769f9bdb7466be65088239c12046d1"],["static/media/glyphicons-halflings-regular.fa277232.woff","fa2772327f55d8198301fdb8bcfc8158"],["static/media/icon.f176732e.png","f176732e59081dd040c0a619a377f3b4"]];
...
var reForAMPContent = /\/amp-pwa\/content\/.*/;
...
self.addEventListener('fetch', function(event) {
  if (event.request.method === 'GET' && event.request.mode === 'navigate') {
    ...
    if (reForAMPContent.test(url.pathname)) {
      event.respondWith(fetch('/amp-pwa'));
    }
  }
});
// [/AMP-PWA]
...
toolbox.router.get("/amp-pwa/content/list.json", toolbox.networkFirst, {});
toolbox.router.get("/amp-pwa/content/*", toolbox.fastest, {"cache":{"maxEntries":10}});
...
self.addEventListener('activate', function(event) {
  ...
  toolbox.cache('/amp-pwa/content/list.json');

  // Precache select runtime fetches.
  fetch('/amp-pwa/content/list.json').then(response => {
